var EmailController = {
    ...
    // axiosLoginUser: (UserEmail, UserPassword) => {
    //     var responseJson;
    //     axios({
    //         method: 'post',
    //         url: 'http://18.191.97.114/api/login',
    //         data: {
    //             username: UserEmail,
    //             password: UserPassword
    //         },
    ...
    // axiosLoginUser: async (UserEmail, UserPassword) => {
    //    response = await axios.post('http://18.191.97.114/api/login', { username: UserEmail, password: UserPassword} )
    //   .then(res => {
    //     console.log(res);
    //   }).catch(function (error) {
    //         console.log(error);
